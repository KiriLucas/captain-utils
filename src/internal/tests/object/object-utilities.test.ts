...
import { ARRAY_OF_NULL, ARRAY_OF_UNDEFINED, ARRAY_WITH_EMPTY_OBJECT, EMPTY_ARRAY, ARRAY_OF_EMPTY_LIKE, NESTED_ARRAY, NESTED_ARRAY_OF_EMPTY_OBJECT, NESTED_ARRAY_OF_EMPTY_LIKE, ARRAY_OF_FALSY, UNORDERED_ARRAY_OF_OBJECTS, ORDERED_ARRAY_OF_OBJECTS } from "../common.mock";

describe('ObjectUtilities', () => {
    describe('orderBy', () => {
        describe('invalid input', () => {
            it.each(ARRAY_OF_FALSY)('should throw a OrderObjectByInvalidParametersException exception when %p is provided as input', (input) => {
